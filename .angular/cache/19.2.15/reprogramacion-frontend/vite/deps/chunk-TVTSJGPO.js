...
var ue = (e = {}, t, r, s4) => {
  if (t) {
    let {
      ...
      prefix: n,
      transform: l
    } = (e == null ? void 0 : e.options) || a2 || {}, o = z(t, k) ? t : `{${t}}`;
...
var b2 = {
  ...
  getCommon({
    ...
    if (s2(a2) && n.transform !== "strict") {
      let {
        ...
        colorScheme: K
      } = f2, A2 = v(f2, ["colorScheme"]), x = re || {}, {
        colorScheme: X
      } = x, G2 = v(x, ["colorScheme"]), p2 = K || {}, {
        dark: U2
      } = p2, B = v(p2, ["dark"]), y = X || {}, {
        dark: I
      } = y, H = v(y, ["dark"]), W = s2(L) ? this._toVariables({
        primitive: L
      }, n) : {}, q2 = s2(A2) ? this._toVariables({
        semantic: A2
      }, n) : {}, Z = s2(B) ? this._toVariables({
        light: B
      }, n) : {}, pe = s2(U2) ? this._toVariables({
        dark: U2
      }, n) : {}, fe = s2(G2) ? this._toVariables({
        semantic: G2
      }, n) : {}, ye = s2(H) ? this._toVariables({
        light: H
      }, n) : {}, Se = s2(I) ? this._toVariables({
        dark: I
      }, n) : {}, [Me, ze] = [(R = W.declarations) != null ? R : "", W.tokens], [Ke, Xe] = [(T = q2.declarations) != null ? T : "", q2.tokens || []], [Ge, Ue] = [(j = Z.declarations) != null ? j : "", Z.tokens || []], [Be, Ie] = [(O = pe.declarations) != null ? O : "", pe.tokens || []], [He, We] = [(M = fe.declarations) != null ? M : "", fe.tokens || []], [qe, Ze] = [(z2 = ye.declarations) != null ? z2 : "", ye.tokens || []], [Fe, Je] = [(V = Se.declarations) != null ? V : "", Se.tokens || []];
      ...
      d = `${et}${tt}`, u = [.../* @__PURE__ */ new Set([...We, ...Ze, ...Je])], h = m(a2.css, {
        dt: E
      });
    }
    return {
  ...
  getPreset({
    ...
    if (s2(t) && r.transform !== "strict") {
      let y = e.replace("-directive", ""), m2 = t, {
        colorScheme: R,
        extend: T,
        css: j
      } = m2, O = v(m2, ["colorScheme", "extend", "css"]), d = T || {}, {
        colorScheme: M
      } = d, z2 = v(d, ["colorScheme"]), u = R || {}, {
        dark: V
      } = u, L = v(u, ["dark"]), h = M || {}, {
        dark: te
      } = h, re = v(h, ["dark"]), K = s2(O) ? this._toVariables({
        [y]: g(g({}, O), z2)
      }, r) : {}, A2 = s2(L) ? this._toVariables({
        [y]: g(g({}, L), re)
      }, r) : {}, X = s2(V) ? this._toVariables({
        [y]: g(g({}, V), te)
      }, r) : {}, [G2, U2] = [(f2 = K.declarations) != null ? f2 : "", K.tokens || []], [B, I] = [(x = A2.declarations) != null ? x : "", A2.tokens || []], [H, W] = [(p2 = X.declarations) != null ? p2 : "", X.tokens || []], q2 = this.transformCSS(y, `${G2}${B}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y, H, "dark", "variable", r, i2, a2, n);
      l = `${q2}${Z}`, o = [.../* @__PURE__ */ new Set([...U2, ...I, ...W])], c = m(j, {
        dt: E
      });
    }
    return {
  ...
  getPresetC({
    ...
    let {
      preset: a2,
      options: n
    } = t, l = (o = a2 == null ? void 0 : a2.components) == null ? void 0 : o[e];
  ...
  getPresetD({
    ...
    let a2 = e.replace("-directive", ""), {
      preset: n,
      options: l
    } = t, o = ((c = n == null ? void 0 : n.components) == null ? void 0 : c[a2]) || ((m2 = n == null ? void 0 : n.directives) == null ? void 0 : m2[a2]);
    return this.getPreset({
      name: a2,
      preset: o,
      options: l,
  ...
  getCommonStyleSheet({
    ...
    let n = this.getCommon({
      ...
      set: i2,
      defaults: a2
    }), l = Object.entries(s4).reduce((o, [c, m2]) => o.push(`${c}="${m2}"`) && o, []).join(" ");
  ...
  getStyleSheet({
    ...
    let n = {
      ...
      set: i2,
      defaults: a2
    }, l = (c = e.includes("-directive") ? this.getPresetD(n) : this.getPresetC(n)) == null ? void 0 : c.css, o = Object.entries(s4).reduce((m2, [d, u]) => m2.push(`${d}="${u}"`) && m2, []).join(" ");
    ...
    if (s2(t)) {
      ...
      if (s4 !== "style") {
        ...
        t = r === "dark" ? c.reduce((m2, {
          type: d,
          selector: u
        }) => (s2(u) && (m2 += u.includes("[CSS]") ? u.replace("[CSS]", t) : this.getSelectorRule(u, l, d, t)), m2), "") : C(l != null ? l : ":root", t);
      }
      if (o) {
        let c = {
          name: "primeui",
        ...
        i(o) && (c.name = m(o.name, {
          name: e,
          type: s4
        })), s2(c.name) && (t = C(`@layer ${c.name}`, t), a2 == null || a2.layerNames(c.name));
      }
      return t;
    }
    return "";
...
var S = {
  ...
  update(e = {}) {
    ...
    }), this._tokens = b2.createTokens(this.preset, this.defaults), this.clearLoadedStyleNames());
  },
  get theme() {
    return this._theme;
  },
  ...
  setPreset(e) {
    this._theme = $(g({}, this.theme), {
      preset: e
    }), this._tokens = b2.createTokens(e, this.defaults), this.clearLoadedStyleNames(), N.emit("preset:change", e), N.emit("theme:change", this.theme);
  },
  getOptions() {
    return this.options;
  },
  ...
  getLayerOrderCSS(e = "") {
    return b2.getLayerOrder(e, this.options, {
      names: this.getLayerNames()
    }, this.defaults);
  },
  transformCSS(e = "", t, r = "style", s4) {
    return b2.transformCSS(e, t, s4, r, this.options, {
      layerNames: this.setLayerNames.bind(this)
    }, this.defaults);
  },
  getCommonStyleSheet(e = "", t, r = {}) {
    return b2.getCommonStyleSheet({
      name: e,
      theme: this.theme,
      params: t,
      props: r,
...
//# sourceMappingURL=chunk-TVTSJGPO.js.map
