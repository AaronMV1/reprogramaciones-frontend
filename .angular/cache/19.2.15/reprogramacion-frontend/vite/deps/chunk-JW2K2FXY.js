...
var BrowserCacheManager = class _BrowserCacheManager extends CacheManager {
  ...
  removeAccountContext(account) {
    return __async(this, null, function* () {
      yield __superGet(_BrowserCacheManager.prototype, this, "removeAccountContext").call(this, account);
...
var StandardInteractionClient = class extends BaseInteractionClient {
   ...
   * @param pkceCodes
   */
  initializeAuthorizationCodeRequest(request, pkceCodes) {
    return __async(this, null, function* () {
      ...
      const generatedPkceParams = pkceCodes || (yield invokeAsync(generatePkceCodes, PerformanceEvents.GeneratePkceCodes, this.logger, this.performanceClient, this.correlationId)(this.performanceClient, this.logger, this.correlationId));
...
var PopupClient = class extends StandardInteractionClient {
  ...
  acquireTokenPopupAsync(request, popupParams, pkceCodes) {
    return __async(this, null, function* () {
      ...
      try {
        const authCodeRequest = yield invokeAsync(this.initializeAuthorizationCodeRequest.bind(this), PerformanceEvents.StandardInteractionClientInitializeAuthorizationCodeRequest, this.logger, this.performanceClient, this.correlationId)(validRequest, pkceCodes);
...
function getPerfMeasurementModule() {
  ...
  try {
    ...
    if (Number(perfEnabled) === 1) {
      return import("./BrowserPerformanceMeasurement-RKHV3PKX.js");
    }
  } catch (e) {
  }
  return void 0;
...
*/
//# sourceMappingURL=chunk-JW2K2FXY.js.map
