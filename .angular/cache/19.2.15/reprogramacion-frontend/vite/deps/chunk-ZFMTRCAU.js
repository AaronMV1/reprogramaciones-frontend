...
var le = (e = {}, t, r, s4) => {
  if (t) {
    let {
      ...
      prefix: n,
      transform: l
    } = (e == null ? void 0 : e.options) || a2 || {}, i2 = z(t, v) ? t : `{${t}}`;
...
function ce(e, t = {}) {
  let r = g.defaults.variable, {
    prefix: s4 = r.prefix,
    selector: o = r.selector,
    excludedKeyRegex: a2 = r.excludedKeyRegex
  } = t, n = [], l = [], i2 = [{
    node: e,
    path: s4
  }];
...
var S = {
  ...
  getCommon({
    ...
    if (s2(a2) && n.transform !== "strict") {
      let {
        ...
        colorScheme: K
      } = y, M = b2(y, ["colorScheme"]), N = re || {}, {
        colorScheme: X
      } = N, B = b2(N, ["colorScheme"]), x = K || {}, {
        dark: G2
      } = x, I = b2(x, ["dark"]), k = X || {}, {
        dark: U2
      } = k, H = b2(k, ["dark"]), W = s2(L) ? this._toVariables({
        primitive: L
      }, n) : {}, q2 = s2(M) ? this._toVariables({
        semantic: M
      }, n) : {}, Z = s2(I) ? this._toVariables({
        light: I
      }, n) : {}, de = s2(G2) ? this._toVariables({
        dark: G2
      }, n) : {}, ue = s2(B) ? this._toVariables({
        semantic: B
      }, n) : {}, pe = s2(H) ? this._toVariables({
        light: H
      }, n) : {}, ge = s2(U2) ? this._toVariables({
        dark: U2
      }, n) : {}, [Le, Me] = [(w2 = W.declarations) != null ? w2 : "", W.tokens], [Ae, je] = [($ = q2.declarations) != null ? $ : "", q2.tokens || []], [De, ze] = [(j = Z.declarations) != null ? j : "", Z.tokens || []], [Ke, Xe] = [(V = de.declarations) != null ? V : "", de.tokens || []], [Be, Ge] = [(D = ue.declarations) != null ? D : "", ue.tokens || []], [Ie, Ue] = [(z2 = pe.declarations) != null ? z2 : "", pe.tokens || []], [He, We] = [(E = ge.declarations) != null ? E : "", ge.tokens || []];
      ...
      u = `${Fe}${Je}`, p2 = [.../* @__PURE__ */ new Set([...Ge, ...Ue, ...We])], h = m(a2.css, {
        dt: P
      });
    }
    return {
  ...
  getPreset({
    ...
    if (s2(t) && r.transform !== "strict") {
      let k = e.replace("-directive", ""), m2 = t, {
        colorScheme: w2,
        extend: $,
        css: j
      } = m2, V = b2(m2, ["colorScheme", "extend", "css"]), u = $ || {}, {
        colorScheme: D
      } = u, z2 = b2(u, ["colorScheme"]), p2 = w2 || {}, {
        dark: E
      } = p2, L = b2(p2, ["dark"]), h = D || {}, {
        dark: te
      } = h, re = b2(h, ["dark"]), K = s2(V) ? this._toVariables({
        [k]: d(d({}, V), z2)
      }, r) : {}, M = s2(L) ? this._toVariables({
        [k]: d(d({}, L), re)
      }, r) : {}, X = s2(E) ? this._toVariables({
        [k]: d(d({}, E), te)
      }, r) : {}, [B, G2] = [(y = K.declarations) != null ? y : "", K.tokens || []], [I, U2] = [(N = M.declarations) != null ? N : "", M.tokens || []], [H, W] = [(x = X.declarations) != null ? x : "", X.tokens || []], q2 = this.transformCSS(k, `${B}${I}`, "light", "variable", r, o, a2, n), Z = this.transformCSS(k, H, "dark", "variable", r, o, a2, n);
      l = `${q2}${Z}`, i2 = [.../* @__PURE__ */ new Set([...G2, ...U2, ...W])], c = m(j, {
        dt: P
      });
    }
    return {
  ...
  getPresetC({
    ...
    let {
      preset: a2,
      options: n
    } = t, l = (i2 = a2 == null ? void 0 : a2.components) == null ? void 0 : i2[e];
  ...
  getPresetD({
    ...
    let a2 = e.replace("-directive", ""), {
      preset: n,
      options: l
    } = t, i2 = ((c = n == null ? void 0 : n.components) == null ? void 0 : c[a2]) || ((m2 = n == null ? void 0 : n.directives) == null ? void 0 : m2[a2]);
    return this.getPreset({
      name: a2,
      preset: i2,
      options: l,
  ...
  getCommonStyleSheet({
    ...
    let n = this.getCommon({
      ...
      set: o,
      defaults: a2
    }), l = Object.entries(s4).reduce((i2, [c, m2]) => i2.push(`${c}="${m2}"`) && i2, []).join(" ");
  ...
  getStyleSheet({
    ...
    let n = {
      ...
      set: o,
      defaults: a2
    }, l = (c = e.includes("-directive") ? this.getPresetD(n) : this.getPresetC(n)) == null ? void 0 : c.css, i2 = Object.entries(s4).reduce((m2, [u, p2]) => m2.push(`${u}="${p2}"`) && m2, []).join(" ");
  ...
  transformCSS(e, t, r, s4, o = {}, a2, n, l) {
    if (s2(t)) {
      ...
      if (s4 !== "style") {
        ...
        t = r === "dark" ? c.reduce((m2, {
          type: u,
          selector: p2
        }) => (s2(p2) && (m2 += p2.includes("[CSS]") ? p2.replace("[CSS]", t) : this.getSelectorRule(p2, l, u, t)), m2), "") : T(l != null ? l : ":root", t);
      }
      if (i2) {
        let c = {
          name: "primeui",
        ...
        i(i2) && (c.name = m(i2.name, {
          name: e,
          type: s4
        })), s2(c.name) && (t = T(`@layer ${c.name}`, t), a2 == null || a2.layerNames(c.name));
      }
      return t;
    }
    return "";
...
var g = {
  ...
  update(e = {}) {
    ...
    t && (this._theme = _2(d({}, t), {
      options: d(d({}, this.defaults.options), t.options)
  ...
  setTheme(e) {
    this.update({
      theme: e
    }), R.emit("theme:change", e);
  },
  getPreset() {
    return this.preset;
  },
  setPreset(e) {
    this._theme = _2(d({}, this.theme), {
      preset: e
    }), this._tokens = S.createTokens(e, this.defaults), this.clearLoadedStyleNames(), R.emit("preset:change", e), R.emit("theme:change", this.theme);
  },
  getOptions() {
    return this.options;
  },
  setOptions(e) {
    this._theme = _2(d({}, this.theme), {
      options: e
    }), this.clearLoadedStyleNames(), R.emit("options:change", e), R.emit("theme:change", this.theme);
  },
  getLayerNames() {
  ...
  getLayerOrderCSS(e = "") {
    return S.getLayerOrder(e, this.options, {
      names: this.getLayerNames()
    }, this.defaults);
  },
  transformCSS(e = "", t, r = "style", s4) {
    return S.transformCSS(e, t, s4, r, this.options, {
      layerNames: this.setLayerNames.bind(this)
    }, this.defaults);
  },
  getCommonStyleSheet(e = "", t, r = {}) {
    return S.getCommonStyleSheet({
      name: e,
      theme: this.theme,
      params: t,
      props: r,
...
var BaseStyle = class _BaseStyle {
  ...
  loadTheme = (options = {}, style3 = "") => {
    return this.load(this.theme, options, (computedStyle = "") => g.transformCSS(options.name || this.name, `${computedStyle}${ar`${style3}`}`));
  };
  loadGlobalCSS = (options = {}) => {
    return this.load(css, options);
  };
  loadGlobalTheme = (options = {}, style$1 = "") => {
    return this.load(style2, options, (computedStyle = "") => g.transformCSS(options.name || this.name, `${computedStyle}${ar`${style$1}`}`));
  };
  ...
  getThemeStyleSheet = (params, props = {}) => {
    let css3 = [g.getStyleSheet(this.name, params, props)];
    if (this.theme) {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function ExclamationTriangleIcon_Template(rf, ctx) {
      if (rf & 1) {
        ɵɵnamespaceSVG();
        ɵɵelementStart(0, "g");
        ɵɵelement(1, "path", 0)(2, "path", 1)(3, "path", 2);
        ɵɵelementEnd();
        ɵɵelementStart(4, "defs")(5, "clipPath", 3);
        ɵɵelement(6, "rect", 4);
        ɵɵelementEnd()();
      }
      if (rf & 2) {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function SortAltIcon_Template(rf, ctx) {
      if (rf & 1) {
        ɵɵnamespaceSVG();
        ɵɵelementStart(0, "g");
        ɵɵelement(1, "path", 0)(2, "path", 1)(3, "path", 2)(4, "path", 3);
        ɵɵelementEnd();
...
@angular/animations/fesm2022/animations.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZFMTRCAU.js.map
